        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10 md:gap-8">
          ...
          <div className="flex flex-col gap-2 md:gap-3 sm:items-end md:col-start-4">
            ...
            <div className="flex gap-4 items-center">
              <SocialIcon
                href="https://wa.me/51906936891?text=Hola%20Tracy,%20acabo%20de%20ver%20tu%20perfil%20y%20me%20interesa%20lo%20que%20haces.%20%C2%BFPodemos%20coordinar%20una%20reuni%C3%B3n%20para%20hablar%20sobre%20un%20proyecto%3F"
                aria="WhatsApp"
