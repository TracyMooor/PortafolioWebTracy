...
const WhatsAppButton: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-6 right-6 md:bottom-8 md:right-8 z-[10010] flex items-center select-none pointer-events-auto">
      {/* Button */}
      <a
        href={whatsappUrl}
        target="_blank"
        rel="noopener noreferrer"
        className="no-cursor-hover w-14 h-14 flex items-center justify-center rounded-full bg-[#25D366] shadow-lg shadow-[#25D366]/20 border border-transparent cursor-pointer"
        aria-label="WhatsApp"
      >
        {/* WhatsApp Icon (SVG) */}
        <svg 
